        ...
        <div class="row px-xl-5">
            <div class="col-lg-8">
                ...
                <div class="collapse mb-5" id="shipping-address">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-light pr-3">Shipping Address</span></h5>
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5">
                    ...
                    <div class="bg-light p-30">
                        ...
                        <button class="btn btn-block btn-custom font-weight-bold py-3">Place Order</button>
                    </div>
                </div>
            </div>
        </div>
